...
public class URLThemeService {
    private static final String URL = "/restful/theme_service";
    public static final String URL_THEME = URL + "/theme";
    public static final String URL_THEMES = URL + "/themes";
